...
$(document).ready(function() {
	...
	var headersSummary, headersDetails = [];

	<?php if (isset($headers)) { ?>
		headersSummary = <?php echo transform_headers($headers['summary'], TRUE); ?>;
		headersDetails = <?php echo transform_headers_readonly($headers['details']); ?>;
	<?php } ?>
	...
	$('#table')
		...
		.bootstrapTable({
			...
			data: <?php echo isset($summary_data) ? json_encode($summary_data, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) : '[]'; ?>,
			iconSize: 'sm',
